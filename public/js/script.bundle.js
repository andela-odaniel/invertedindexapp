...
},{"../../src/inverted-index":4,"jquery":1,"lodash":2}],4:[function(require,module,exports){
"use strict";
var _ = require('lodash');
...
var Index = function(){
  ...
  this.searchIndex = function(arrayOfFileIndices,arrayOfSearchTerms){
    //if no file Indexes passed, search all files
    if(arrayOfFileIndices === undefined || arrayOfFileIndices === null){
      arrayOfFileIndices = Object.keys(this.getFiles());
    }
    ...
    return this.searchArray(arrayOfFileIndices,searchTerms);
  };
